...
const HeroSlider = () => {
  return (
    <Swiper modules={[EffectFade, Autoplay]} effect={'fade'} loop={true} autoplay={{delay: 2000, disableOnInteraction: false}} className='heroSlider h-[600px] lg:h-[860px]'>
      {
        slides.map((slide, index) => {
          ...
          return (
            <SwiperSlide key={index} className='h-full bg-pink-400 relative flex justify-center items-center'>
